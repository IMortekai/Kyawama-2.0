...
Read `AGENTS.md`, then these files in order:
1. `docs/MASTER-BRIEF.md`
2. `docs/SOURCE-OF-TRUTH.md`
3. `docs/HOMEPAGE-SPEC.md`
4. `docs/BRAND.md`, `docs/DESIGN-DIRECTION.md`, `docs/MOTION-SYSTEM.md`
5. `docs/IMPLEMENTATION-START.md`

Load the remaining docs when their topic is needed. Use `content/homepage-draft.json` as draft content, not an approved publication file. Do not repeatedly consume the raw capture; use its numbered sections only to resolve a specific fact.
