...
## Name and wordmark
Use **Kyawama** in ordinary copy and **The Kyawama Foundation** where the full public brand is appropriate. Keep legal claims separate. The observed wordmark is built from styled text; no original logo file was supplied or identified as an image asset in the inspected views. Request the approved original rather than tracing it from a screenshot. Use a simple Kyawama text label as an explicitly provisional local fallback.
